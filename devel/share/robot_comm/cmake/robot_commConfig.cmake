...
if("TRUE" STREQUAL "TRUE")
  set(robot_comm_SOURCE_PREFIX /home/rosuser/rosdev/nla-tarea-01/src/robot_comm)
  set(robot_comm_DEVEL_PREFIX /home/rosuser/rosdev/nla-tarea-01/devel)
  ...
  set(robot_comm_INSTALL_PREFIX /home/rosuser/rosdev/nla-tarea-01/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'rosuser <rosuser@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosuser/rosdev/nla-tarea-01/src/robot_comm/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robot_comm_NUM_DUMMY_TARGETS)
      set(robot_comm_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_comm::wrapped-linker-option${robot_comm_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_comm_NUM_DUMMY_TARGETS "${robot_comm_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_comm::wrapped-linker-option${robot_comm_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_comm_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rosuser/rosdev/nla-tarea-01/devel/lib;/home/rosuser/rosdev/catkin_ws/devel/lib;/home/rosuser/rosdev/simulation_ws/devel/lib;/home/rosuser/rosdev/robot_ws/devel/lib;/opt/ros/melodic/lib)
