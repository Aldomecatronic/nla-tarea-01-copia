...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rosuser/rosdev/nla-tarea-01/install/lib;/home/rosuser/rosdev/catkin_ws/devel/lib;/home/rosuser/rosdev/simulation_ws/devel/lib;/home/rosuser/rosdev/robot_ws/devel/lib;/opt/ros/melodic/lib)
